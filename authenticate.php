...
if ($googleClient->getAccessToken()) {
	...
	$sqlaccess = "SELECT * FROM access_rules WHERE email='".$email_id."'";
	echo $sqlaccess;
	$res_access = $conn->query($sqlaccess);
	$userDataAccess = $res_access->fetch_assoc();
	$_SESSION['userData'] = $userData;
	$_SESSION['userAccessRule'] = $userDataAccess;
